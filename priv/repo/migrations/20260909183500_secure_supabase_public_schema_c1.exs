defmodule StrangertalksNew.Repo.Migrations.SecureSupabasePublicSchemaC1 do
  use Ecto.Migration
  ...
  def down do
    raise "C1 Supabase public-schema security closure is intentionally irreversible; restore a captured pre-change database state instead of reopening Data API access"
  end
