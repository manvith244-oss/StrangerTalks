defmodule StrangertalksNew.Repo.Migrations.SecureLivingThreadPilot do
  use Ecto.Migration
  ...
  def up do
    Enum.each(@pilot_tables, fn table ->
  ...
  def down do
    raise "Living Thread pilot security closure is intentionally irreversible; restore a captured pre-change database state instead of reopening Data API access"
  end
