defmodule StrangertalksNew.IcebreakerCatalog do
  ...
  @localized_text %{
    ...
    "te" => %{
      ...
      "tiny-smile-story" => "ఇటీవల మీకు చిరునవ్వు తెప్పించిన చిన్న విషయం గురించి ఒక చిన్న కథ చెప్పండి.",
      "instant-skill" => "హానికరం కాని ఒక నైపుణ్యాన్ని వెంటనే నేర్చుకోగలిగితే, ఏదిని ఎంచుకుంటారు?",
      "new-city-afternoon" => "మీ ఇద్దరికీ కొత్త నగరంలో ఖాళీ మధ్యాహ్నం ఉందని ఊహించండి—ఎక్కడి నుంచి మొదలుపెడతారు?",
      "small-comfort" => "మరింత మంది తెలుసుకోవాలని మీరు అనుకునే చిన్న సాంత్వన ఏమిటి?",
      "ordinary-meaning" => "సాధారణంగా కనిపించినా, మీకు ఊహించినదానికంటే ఎక్కువ అర్థం కలిగిన విషయం ఏమిటి?",
      "conversation-direction" => "మాటలను తేలికగా ఉంచాలా, కథలు పంచుకోవాలా, లేక అర్థవంతమైన విషయం గురించి మాట్లాడాలా?"
    },
    "hi" => %{
      "ocean-or-space" => "आप समुद्र की खोज करना चाहेंगे या अंतरिक्ष की?",
      "tiny-smile-story" => "हाल ही में किसी छोटी-सी बात ने आपको मुस्कुराया हो, उसकी एक छोटी कहानी बताइए।",
      "instant-skill" => "अगर आप तुरंत कोई एक सुरक्षित कौशल सीख सकते, तो वह क्या होता?",
      "new-city-afternoon" => "मान लीजिए आप दोनों के पास किसी नए शहर में एक खाली दोपहर है—आप कहाँ से शुरुआत करेंगे?",
      "small-comfort" => "ऐसी कौन-सी छोटी-सी चीज़ है जो आपको सुकून देती है और जिसे अधिक लोगों को जानना चाहिए?",
      "ordinary-meaning" => "ऐसी कौन-सी साधारण चीज़ है जिसका आपके लिए लोगों की अपेक्षा से ज़्यादा महत्व है?",
      "conversation-direction" =>
