...
{:ok, participant_a} = StrangertalksNew.Participants.create_participant(%{created_at: valid_time})
{:ok, participant_b} = StrangertalksNew.Participants.create_participant(%{created_at: valid_time})
...
attrs = %{
  ...
  relationship_summary: %{"summary" => "t09-migration"}
}

{:ok, relationship} = StrangertalksNew.Relationships.create_relationship(attrs)
IO.puts("T09_SEEDED_RELATIONSHIP=#{relationship.relationship_id}")
