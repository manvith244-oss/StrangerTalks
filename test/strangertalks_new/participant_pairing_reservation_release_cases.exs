defmodule StrangertalksNew.ParticipantPairingReservationReleaseTest do
  ...
  test "release-terminal classifier recognizes exactly ENDED ABANDONED FAILED and rejects COMPLETED" do
    ...
    IO.puts(
      "REL-05 PASS classifier release=ENDED,ABANDONED,FAILED keep=PENDING,ACTIVE,PAUSED,COMPLETED"
    )
  end
